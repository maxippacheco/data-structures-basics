...
var FilterArr = [2, 3, 4, 5, 6, 7, 8, 9, 10];
...
var trueArr = [3, 5, 7, 9, 15];
var isTruthly = function (numbers) {
...
trueArr.forEach(function (element) {
    // console.log(element);
});
for (var _i = 0, trueArr_1 = trueArr; _i < trueArr_1.length; _i++) {
    var element = trueArr_1[_i];
    //Mismo que forEach
    // console.log(element);
}
//COPIAR UN ARRAY E INSERTARLO A OTRO   
var trueArr2 = Array.from(trueArr);
// console.log(trueArr2);
//CREAR UN ARRAY A PARTIR DE ARGUMENTOS DADOS
var arr_strings = Array.of('Mario', 'Pepe', 'Silvio');
// console.log(arr_strings);
//We can also use this method to make a copy of an existing array
var arr_strings_copy = Array.of.apply(Array, arr_strings);
...
temperatureOfTheWeek[0].sort(function (a, b) {
    //Menor a mayor
...
var namesSort = ['Jake', 'Bryan', 'Alex', 'Max'];
function compareToNames(a, b) {
...
var findArr = [26, 39, 21, 45, 52];
var multipleOf13 = function (element) { return (element % 13 === 0) ? true : false; };
